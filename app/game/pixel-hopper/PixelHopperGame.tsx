...
export default function PixelHopperGame() {
    ...
    const collision = gameState.obstacles.some(
      (obstacle) =>
        ...
        gameState.player.y + PLAYER_HEIGHT >
          GAME_HEIGHT - GROUND_HEIGHT - OBSTACLE_HEIGHT
    );
  ...
  const renderSVGToImage = (SvgComponent: React.FC): HTMLImageElement => {
    const svgString = encodeURIComponent(
      ReactDOMServer.renderToString(<SvgComponent />)
    );
    const img = new Image();
