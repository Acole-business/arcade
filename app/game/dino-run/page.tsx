...
export default function DinoRun() {
  ...
  const resetGame = useCallback(() => {
    gameStateRef.current = {
      dino: {
        x: 50,
        y: GAME_HEIGHT - GROUND_HEIGHT - DINO_HEIGHT,
        velocityY: 0,
      },
      cacti: [],
      score: 0,
  ...
  const gameLoop = useCallback(() => {
    ...
    gameState.dino.y = Math.min(
      gameState.dino.y + gameState.dino.velocityY,
      GAME_HEIGHT - GROUND_HEIGHT - DINO_HEIGHT
    );
    ...
    const collision = gameState.cacti.some(
      (cactus) =>
        ...
        gameState.dino.y + DINO_HEIGHT >
          GAME_HEIGHT - GROUND_HEIGHT - CACTUS_HEIGHT
    );
      ...
      <div className="terminal-container flex-1 border border-green-500 rounded-md p-4 relative">
        ...
        <div className="game-container space-y-6">
          <div className="game-info text-center">
            ...
            <p className="text-sm">
              Jump over cacti and survive as long as you can!
            </p>
          ...
          {gameOver && (
            <div className="text-center">
              <p className="text-xl mb-4">
                Game Over! Your score: {gameStateRef.current.score}
              </p>
              <button
                onClick={startGame}
